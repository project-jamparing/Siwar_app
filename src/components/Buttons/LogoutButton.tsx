    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm transition-all">
          <div className="bg-white text-gray-800 p-6 md:p-8 rounded-2xl shadow-2xl w-[90%] max-w-md animate-fade-in-up">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className="px-4 py-2 rounded-lg text-gray-700 border border-gray-300 hover:bg-gray-100 transition focus:outline-none focus:ring-2 focus:ring-gray-400"
              >
                Batal
              </button>
              <button
