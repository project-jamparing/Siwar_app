...
import { Home, Users, Users2, Megaphone, Bell, History, Lock, File, CreditCard } from "lucide-react";
...
> = {
  "1": [
    ...
    { label: "Data RW/RT", href: "/dashboard/admin/DataRW/RT", icon: <History className="w-5 h-5" /> },
    { label: "Data Warga", href: "/dashboard/admin/warga", icon: <Users2 className="w-5 h-5" /> },
    { label: "Data KK", href: "/dashboard/admin/kepala-keluarga", icon: <File className="w-5 h-5" /> },
  ...
  "2": [
    ...
    { label: "Data KK", href: "/dashboard/rw/kepala-keluarga", icon: <File className="w-5 h-5" /> },
    { label: "Data Iuran", href: "/dashboard/rw/iuaran", icon: <CreditCard className="w-5 h-5" /> },
  ...
  "3": [
    ...
    { label: "Data KK", href: "/dashboard/rt/kepala-keluarga", icon: <File className="w-5 h-5" /> },
    { label: "Data Iuran RT", href: "/dashboard/rt/iuran", icon: <CreditCard className="w-5 h-5" /> },
  ...
  "4": [
    ...
    { label: "Iuran Saya", href: "/dashboard/warga/iuran", icon: <CreditCard className="w-5 h-5" /> },
