...
CREATE TABLE `iuran` (
    ...
    `kategori_id` INTEGER UNSIGNED NOT NULL,
...
-- AddForeignKey
ALTER TABLE `kk` ADD CONSTRAINT `kk_ibfk_2` FOREIGN KEY (`rt_id`) REFERENCES `rukun_tetangga`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `warga` ADD CONSTRAINT `warga_ibfk_1` FOREIGN KEY (`no_kk`) REFERENCES `kk`(`no_kk`) ON DELETE CASCADE ON UPDATE RESTRICT;
